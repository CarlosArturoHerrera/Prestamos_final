...
export function ClientsDataTable({
  ...
  const columns: ColumnDef<Client>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span
          className={`font-medium ${getStatusColor(row.getValue("status"))}`}
        >
          {row.getValue("status")}
        </span>
      ),
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <Badge variant={getRiskBadgeVariant(risk)}>{risk}</Badge>;
      },
    },
    {
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p
                    className={`font-medium ${getStatusColor(viewClient.status)}`}
                  >
                    {viewClient.status}
                  </p>
                </div>
                <div>
                  ...
                  <Badge
                    variant={getRiskBadgeVariant(viewClient.riskLevel)}
                    className="mt-1 ml-1"
                  >
                ...
                <div>
                  ...
                  <p className="font-medium text-sm">
                    {new Date(viewClient.lastPayment).toLocaleDateString(
                      "es-ES",
                    )}
                  </p>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-2">
                ...
                <PhoneInput
                  ...
                  onChange={(raw) =>
                    setEditClient({ ...editClient, phone: raw })
                  }
                />
              </div>
              <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                ...
                <Select
                  value={editClient.segment}
                  onValueChange={(value) =>
                    setEditClient({ ...editClient, segment: value })
                  }
                >
                  <SelectTrigger>
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      if (!response.ok) {
                        ...
                        throw new Error(
                          error.error || "Error al actualizar cliente",
                        );
                      }
