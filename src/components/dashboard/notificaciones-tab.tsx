    ...
    const loadNotifications = async () => {
      try {
        ...
        if (!res.ok) {
          ...
          throw new Error(
            errorData.error || "No se pudieron cargar las notificaciones",
          );
        }
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Historial de notificaciones enviadas a tus clientes por WhatsApp y
          correo
        </p>
      </div>
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                {stats.total
                  ? ((stats.whatsapp / stats.total) * 100).toFixed(0)
                  : 0}
                % del total
              </p>
            </div>
        ...
        <Card className="stat-card">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                {stats.total
                  ? ((stats.email / stats.total) * 100).toFixed(0)
                  : 0}
                % del total
              </p>
            </div>
                ...
                {isLoading ? (
                  ...
                  notifications.map((notification) => {
                    ...
                    return (
                      ...
                      >
                        <td className="h-14 px-4 align-middle font-medium">
                        ...
                        <td className="h-14 px-4 align-middle text-center text-xs">
                          ...
                          <div className="text-muted-foreground">
                            {format(displayDate, "HH:mm", { locale: es })}
                          </div>
                        </td>
