...
export default function ReportesPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (filtros.representanteId)
      q.set("representanteId", filtros.representanteId);
  ...
  const pieData = Object.entries(estadosCount).map(([name, value]) => ({
    name,
    value,
  }));
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Cartera filtrable y exportación PDF / Excel.
        </p>
      </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setFiltros({ ...filtros, empresaId: v === "all" ? "" : v })
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setFiltros({ ...filtros, estado: v === "all" ? "" : v })
                }
              >
                <SelectTrigger>
                  <SelectValue />
              ...
              rows.map((r) => {
                ...
                return (
                  <TableRow key={String(r.id)}>
                    ...
                    <TableCell>
                      {formatRD(r.capital_pendiente as string)}
                    </TableCell>
