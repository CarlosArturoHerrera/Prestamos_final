...
export async function POST(request: NextRequest) {
  try {
    ...
    console.warn(
      "No hay servicio STT configurado. Configure GOOGLE_CLOUD_STT_API_KEY o DEEPGRAM_API_KEY",
    );
    return NextResponse.json(
      {
        ...
        text: "",
        message:
          "No hay servicio de reconocimiento de voz configurado. Configura Google Cloud o Deepgram. Ver ALTERNATIVE_SERVICES.md",
      },
      { status: 503 },
    );
  } catch (error) {
